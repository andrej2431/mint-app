...
const Notification = ({ type, message, description, txid, onHide }) => {
  ...
  return (
    <div
      className={`max-w-sm w-full bg-bkg-1 shadow-lg rounded-md mt-2 pointer-events-auto ring-1 ring-black bg-white ring-opacity-5 p-1 mx-2 mb-12 overflow-hidden`}
    >
      <div className={`p-4 rounded-md bg-[#910808]`}>
