...
export const CandyMint: FC = () => {
    ...
    return (
        ...
        <div className="relative">
            <button
            className="px-10 py-5 m-2 rounded-lg bg-[#feaf27] text-[#b30b0a] border-2 border-[#feaf27] font-bold hover:bg-[#921918] font-saira hover:border-2 hover:border-white hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 transition duration-300 text-3xl"
            onClick={onClick}>
            Mint NFT
            </button>
        </div>
